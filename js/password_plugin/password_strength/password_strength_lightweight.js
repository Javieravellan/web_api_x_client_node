...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype._create = function () {
        ...
        this.element.append('<div class="pswd_info" style="display: none; width: 65%;"> \
            <h4>La contraseña debe incluir:</h4> \
            <ul> \
            <li data-criterion="length" class="valid">8-20 <strong>Caracteres</strong></li> \
            <li data-criterion="capital" class="valid">Al menos <strong>una letra mayúscula</strong></li> \
            <li data-criterion="number" class="valid">Al menos <strong>un número</strong></li> \
            <li data-criterion="letter" class="valid">No espacios en blanco</li> \
            </ul> \
            </div>');
